...
class OnlyRecentVisitor extends StatelessWidget {
  const OnlyRecentVisitor({Key? key}) : super(key: key);
                                  ...
                                  Row(
                                    children: [
                                      SizedBox(
                                          height: 20,
                                          width: 20,
                                          child: Image.asset('assets/images/recent_visitor.png')),
                                      const Text('  Rajesh Mehra (Recent Visitors)  ',
                                        style: TextStyle(
                                            fontSize: 16,
                                            color: Colors.black),),
                                    ],
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children:  const [
                                        Text(' Rajesh Mehra (Recent Visitors)  ',
                                          style: TextStyle(
                                              fontSize: 16,
                                              color: Colors.black),),
