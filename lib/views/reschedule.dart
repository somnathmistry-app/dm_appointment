...
class _RescheduleState extends State<Reschedule> {
  ...
  @override
  void initState() {
    dateInput.text = "19-05-2022"; //set the initial value of text field
    timeInput.text = '15:40';
    super.initState();
  }
          ...
          children:  [
            ...
            Container(
              ...
              child: ElevatedButton(
                  ...
                  child: MyWidgets.textView("Save Change", AppColors.white, 16)),
            ),
            const SizedBox(height: 20),
          ],
        ),
