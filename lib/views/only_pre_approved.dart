import 'package:dm_appointment/utils/constants/size_oriantation.dart';
import 'package:flutter/material.dart';

import '../styles/app_colors.dart';


class OnlyPreApproved extends StatelessWidget {
  const OnlyPreApproved({Key? key}) : super(key: key);
                                ...
                                children: [
                                  const Expanded(
                                    child: Padding(
                                      ...
                                      child: Text(
                                        'Details  -  For Residential purpose',
                                        style: TextStyle(
                                            fontSize: 14,
                                            color: Colors.black),),
                                    ),
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children:  const [
                                        Text(' Rajesh Mehra (Pre Approved)  ',
                                          style: TextStyle(
                                              fontSize: 16,
                                              color: Colors.black),),
